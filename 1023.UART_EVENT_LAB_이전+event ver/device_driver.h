...
extern void TIM4Out_PWM_Generation(unsigned short freq, unsigned short duty);
extern void TIM4_Out_Stop(void);
extern void TIM4_Change_Duty(unsigned int duty);
extern void TIM4_Out_Init(void);
extern void TIM4_Out_Freq_Generation(unsigned short freq);
extern void TIM4_Repeat_Interrupt_Enable(int en, int time);
extern void TIM4_Interrupt_Init(int time_ms);
