...
#define RCC_APB2ENR   (*(volatile unsigned long*)0x40010800)

#define GPIOB_CRL      (*(volatile unsigned long*)0x40010800)
#define GPIOB_ODR      (*(volatile unsigned long*)0x4001080C)
